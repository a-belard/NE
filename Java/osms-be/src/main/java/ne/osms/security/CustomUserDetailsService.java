...
import ne.osms.repositories.IUserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws BadRequestException {
        User user = userRepository.findByEmailOrPhone(s, s).orElseThrow(() -> new UsernameNotFoundException("user not found with username or phone of " + s));
